...
#define GATEWARE_ENABLE_MATH // Math Libraries Enabeled
#define GATEWARE_ENABLE_INPUT // Input Library (used for keyboard/controller input)
...
#include "../DirectX11/gateware-main/gateware-main/Gateware.h"
...
int main()
{
	...
	{
		// TODO: Part 1A 
		win.SetWindowName("Zachary Giffin - Assignment 2 - D3D11");
		float clr[] = { 0/255.0f, 0.0f, 0/255.0f, 1 }; // TODO: Part 1A (optional)
		...
		if (+d3d11.Create(win, GW::GRAPHICS::DEPTH_BUFFER_SUPPORT))
		{
			...
			while (+win.ProcessWindowEvents())
			{
					...
					+d3d11.GetSwapchain((void**)&swap))
				{
					...
					bool camera = renderer.ChangeCamera();
					renderer.Render();
					swap->Present(1, 0);
